...
const slugs = dataFromStringToObject.map((el) => slugify(el.productName, { lower: true }));
console.log(slugs);
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/' || pathname === '/overview') {
    ...
    const cardsHtml = dataFromStringToObject.map((el) => replaceTemplate(tempCard, el)).join('');
